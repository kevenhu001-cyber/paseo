...
The built-in, user-facing providers are Claude Code, Codex, Copilot, OpenCode, Pi, OMP, and Antigravity. Additional adapters exist in the same directory for ACP-compatible agents and internal use:
